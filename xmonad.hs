...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- Lower Volume
    , ((modm              , xK_Page_Down), spawn "amixer set Master unmute & amixer set PCM 7%-")

    -- Raise Volume
    , ((modm              , xK_Page_Up), spawn "amixer set Master unmute & amixer set PCM 7%+")

    -- Mute Volume
    , ((modm              , xK_End), spawn "amixer set Master toggle")
    ]
    ++
